...
import KeyRegistryABI from '../../../contracts/artifacts/contracts/KeyRegistry.sol/KeyRegistry.json';
...
export class MessageValidator {
    ...
    constructor(config) {
        ...
        if (process.env.KEY_REGISTRY_ADDRESS) {
            this.keyRegistry = new ethers.Contract(process.env.KEY_REGISTRY_ADDRESS, KeyRegistryABI.abi, this.provider);
